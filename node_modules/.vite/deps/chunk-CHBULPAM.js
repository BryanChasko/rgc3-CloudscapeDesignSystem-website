  ...
  function() {
    ...
    PanoramaClient2.prototype.sendMetric = function(metric) {
      ...
      if (typeof panorama === "function") {
        panorama("trackCustomEvent", __assign({ timestamp: Date.now() }, metric));
      }
    };
...
var Metrics = (
  ...
  function() {
    ...
    Metrics2.prototype.sendMetricObjectOnce = function(metric, value) {
      var metricKey = jsonStringify(metric);
    ...
    Metrics2.prototype.logComponentsLoaded = function() {
      this.sendMetricObjectOnce({ source: this.source, action: "loaded", version: this.packageVersion }, 1);
    };
    Metrics2.prototype.logComponentUsed = function(componentName, configuration) {
...
// node_modules/@cloudscape-design/component-toolkit/internal/base-component/component-metrics.js
function useComponentMetrics(componentName, _a, configuration) {
...
var PACKAGE_VERSION = "3.0.0 (e5a694ee)";
...
import "/home/bryanchasko/code/rgc3/node_modules/@cloudscape-design/components/internal/base-component/styles.scoped.css";
...
//# sourceMappingURL=chunk-CHBULPAM.js.map
