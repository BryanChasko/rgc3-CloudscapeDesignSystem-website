...
import "/home/bryanchasko/code/rgc3/node_modules/@cloudscape-design/components/column-layout/flexible-column-layout/styles.scoped.css";
...
function FlexibleColumnLayout({ columns = 1, minColumnWidth = 0, disableGutters, variant, children }) {
  ...
  return import_react.default.createElement("div", { ref: containerRef, className: clsx_m_default(styles_css_default["css-grid"], styles_css_default[`grid-variant-${variant}`], shouldDisableGutters && [styles_css_default["grid-no-gutters"]]), style: { gridTemplateColumns: `repeat(${columnCount}, 1fr)` } }, flattenedChildren.map((child, i) => {
    const key = child.key;
...
import "/home/bryanchasko/code/rgc3/node_modules/@cloudscape-design/components/column-layout/styles.scoped.css";
...
function GridColumnLayout({ columns, variant, borders, disableGutters, __breakpoint, children }) {
  ...
  }), __breakpoint: __breakpoint || breakpoint, __responsiveClassName: (breakpoint2) => breakpoint2 && styles_css_default2[`grid-breakpoint-${breakpoint2}`] }, children);
}
...
function ColumnLayout(_a) {
  ...
  return import_react3.default.createElement("div", Object.assign({}, baseProps, { className: clsx_m_default(baseProps.className, styles_css_default2["column-layout"]), ref: __internalRootRef }), minColumnWidth ? import_react3.default.createElement(FlexibleColumnLayout, { columns, borders, variant, minColumnWidth, disableGutters }, children) : import_react3.default.createElement(GridColumnLayout, { columns, variant, borders, disableGutters, __breakpoint }, children));
}

export {
  ColumnLayout
};
//# sourceMappingURL=chunk-6JOXQN6U.js.map
