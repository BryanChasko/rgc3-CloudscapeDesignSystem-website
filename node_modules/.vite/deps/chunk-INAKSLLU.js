...
import "/home/bryanchasko/code/rgc3/node_modules/@cloudscape-design/components/internal/components/dropdown-footer/styles.scoped.css";
...
import "/home/bryanchasko/code/rgc3/node_modules/@cloudscape-design/components/internal/components/dropdown-status/styles.scoped.css";
...
var useDropdownStatus = ({ statusType, empty, loadingText, finishedText, filteringResultsText, errorText, recoveryText, isEmpty, isNoMatch, isFiltered, noMatch, onRecoveryClick, hasRecoveryCallback = false, errorIconAriaLabel }) => {
  ...
  if (statusType === "loading") {
    ...
    statusResult.content = import_react.default.createElement(
      "span",
      null,
      import_react.default.createElement(StatusIndicator, { type: "error", __display: "inline", __animate: previousStatusType !== "error", iconAriaLabel: errorIconAriaLabel }, errorText),
      " ",
      !!recoveryText && hasRecoveryCallback && import_react.default.createElement(internal_default2, { onFollow: () => fireNonCancelableEvent(onRecoveryClick), variant: "recovery", className: styles_css_default2.recovery }, recoveryText)
    );
...
function useHighlightedOption({ options, isHighlightable }) {
  ...
  const [highlightType, setHighlightType] = (0, import_react3.useState)(new HighlightType("keyboard"));
...
import "/home/bryanchasko/code/rgc3/node_modules/@cloudscape-design/components/select/parts/styles.scoped.css";
...
import "/home/bryanchasko/code/rgc3/node_modules/@cloudscape-design/components/internal/components/option/styles.scoped.css";
...
import "/home/bryanchasko/code/rgc3/node_modules/@cloudscape-design/components/internal/components/selectable-item/styles.scoped.css";
...
import "/home/bryanchasko/code/rgc3/node_modules/@cloudscape-design/components/internal/components/button-trigger/styles.scoped.css";
...
// node_modules/@cloudscape-design/components/select/parts/trigger.js
var Trigger = import_react22.default.forwardRef(({ ariaLabelledby, ariaDescribedby, controlId, invalid, triggerProps, selectedOption, selectedOptions, triggerVariant, inFilteringToken, isOpen, placeholder, disabled }, ref) => {
  ...
  if (triggerVariant === "tokens") {
    if (selectedOptions === null || selectedOptions === void 0 ? void 0 : selectedOptions.length) {
      triggerContent = import_react22.default.createElement(
        "span",
        { className: clsx_m_default(styles_css_default3["inline-token-trigger"], disabled && styles_css_default3["inline-token-trigger--disabled"], isVisualRefresh && styles_css_default3["visual-refresh"]) },
        import_react22.default.createElement("span", { className: styles_css_default3["inline-token-list"] }, selectedOptions.map(({ label }, i) => import_react22.default.createElement("span", { key: i, className: styles_css_default3["inline-token"] }, label))),
        import_react22.default.createElement(
          "span",
          { className: styles_css_default3["inline-token-counter"], id: triggerContentId },
          import_react22.default.createElement("span", { className: styles_css_default3["inline-token-hidden-placeholder"] }, placeholder),
          import_react22.default.createElement(
            "span",
            null,
            "(",
  ...
  return import_react22.default.createElement(button_trigger_default, Object.assign({}, triggerProps, { id, ref: mergedRef, pressed: isOpen, disabled, invalid, inFilteringToken, inlineTokens: triggerVariant === "tokens", ariaDescribedby, ariaLabelledby: ariaLabelledbyIds }), triggerContent);
});
...
import "/home/bryanchasko/code/rgc3/node_modules/@cloudscape-design/components/token-group/styles.scoped.css";
...
import "/home/bryanchasko/code/rgc3/node_modules/@cloudscape-design/components/internal/components/token-list/styles.scoped.css";
...
// node_modules/@cloudscape-design/components/internal/components/token-list/index.js
function TokenList({ items, alignment, renderItem, limit, after, i18nStrings, moveFocusNextToIndex, onExpandedClick = () => void 0 }) {
  ...
  const toggle = hasHiddenItems ? import_react25.default.createElement(
    ...
    import_react25.default.createElement(TokenLimitToggle, { controlId: hasVisibleItems ? controlId : void 0, allHidden: limit === 0, expanded, numberOfHiddenOptions: items.length - visibleItems.length, i18nStrings, onClick: () => {
...
function DismissButton({ disabled, dismissLabel, onDismiss }, ref) {
  return import_react26.default.createElement(
    "button",
    { ref, type: "button", className: clsx_m_default(styles_css_default7["dismiss-button"]), "aria-disabled": disabled ? true : void 0, onClick: !disabled && onDismiss ? () => onDismiss() : void 0, "aria-label": dismissLabel },
...
function InternalTokenGroup(_a) {
  var { alignment, items, onDismiss, limit, i18nStrings, disableOuterPadding, __internalRootRef } = _a, props2 = __rest(_a, ["alignment", "items", "onDismiss", "limit", "i18nStrings", "disableOuterPadding", "__internalRootRef"]);
  ...
  return import_react28.default.createElement(
    "div",
    Object.assign({}, baseProps, { className: clsx_m_default(baseProps.className, styles_css_default7.root, hasItems && styles_css_default7["has-items"], disableOuterPadding && styles_css_default7["no-padding"]), ref: __internalRootRef }),
    ...
    ), i18nStrings, moveFocusNextToIndex: removedItemIndex, onExpandedClick: (isExpanded) => {
      if (isExpanded && limit) {
...
import "/home/bryanchasko/code/rgc3/node_modules/@cloudscape-design/components/multiselect/styles.scoped.css";
...
var InternalMultiselect = import_react29.default.forwardRef((_a, externalRef) => {
  ...
  return import_react29.default.createElement(
    ...
    showTokens && import_react29.default.createElement(InternalTokenGroup, { className: styles_css_default9.tokens, alignment: "horizontal", limit: tokenLimit, items: tokens, onDismiss: handleTokenDismiss, i18nStrings: tokenGroupI18nStrings, disableOuterPadding: true }),
...
//# sourceMappingURL=chunk-INAKSLLU.js.map
