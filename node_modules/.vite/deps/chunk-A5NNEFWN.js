...
import "/home/bryanchasko/code/rgc3/node_modules/@cloudscape-design/components/status-indicator/styles.scoped.css";
...
function StatusIndicator(_a) {
  ...
  return import_react.default.createElement(
    "span",
    Object.assign({}, baseProps, { className: clsx_m_default(styles_css_default.root, styles_css_default[`status-${type}`], {
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement(
        "span",
        { className: clsx_m_default(styles_css_default.icon, __animate && styles_css_default["icon-shake"]), "aria-label": iconAriaLabel, role: iconAriaLabel ? "img" : void 0 },
        typeToIcon(__size)[type],
        __display === "inline" && import_react.default.createElement(import_react.default.Fragment, null, " ")
      ),
      children
    )
  );
...
//# sourceMappingURL=chunk-A5NNEFWN.js.map
