...
import "/home/bryanchasko/code/rgc3/node_modules/@cloudscape-design/components/top-navigation/styles.scoped.css";
...
function useTopNavigation({ identity, search, utilities }) {
  ...
  const responsiveStates = (0, import_react.useMemo)(() => {
    return generateResponsiveStateKeys(utilities, hasSearch, hasTitleWithLogo);
  }, [utilities, hasSearch, hasTitleWithLogo]);
  const [responsiveState, setResponsiveState] = (0, import_react.useState)();
  const recalculateFit = (0, import_react.useCallback)(() => {
    var _a, _b, _c, _d;
  ...
  const onVirtualMount = (0, import_react.useCallback)((element) => {
    virtualRef.current = element;
    recalculateFit();
  }, [recalculateFit]);
  const [isSearchMinimized, setSearchMinimized] = (0, import_react.useState)(true);
...
import "/home/bryanchasko/code/rgc3/node_modules/@cloudscape-design/components/internal/components/menu-dropdown/styles.scoped.css";
...
// node_modules/@cloudscape-design/components/internal/components/menu-dropdown/index.js
var ButtonTrigger = import_react2.default.forwardRef(({ testUtilsClass, iconName, iconUrl, iconAlt, iconSvg, badge, ariaLabel, offsetRight, disabled, expanded, children, onClick }, ref) => {
  const hasIcon = iconName || iconUrl || iconSvg;
  return import_react2.default.createElement(
    "button",
    { ref, type: "button", className: clsx_m_default(styles_css_default3.button, styles_css_default3[`offset-right-${offsetRight}`], testUtilsClass, {
    ...
    hasIcon && import_react2.default.createElement(internal_default, { className: styles_css_default3.icon, name: iconName, url: iconUrl, alt: iconAlt, svg: iconSvg, badge }),
    children && import_react2.default.createElement("span", { className: styles_css_default3.text }, children),
    children && import_react2.default.createElement(internal_default, { name: "caret-down-filled", className: expanded ? styles_css_default["rotate-up"] : styles_css_default["rotate-down"] })
  );
});
var MenuDropdown = (_a) => {
  ...
  const dropdownTrigger = ({ triggerRef, ariaLabel, isOpen, testUtilsClass, disabled, onClick }) => {
    return import_react2.default.createElement(ButtonTrigger, { testUtilsClass, ref: triggerRef, disabled, expanded: isOpen, iconName, iconUrl, iconAlt, iconSvg, badge, ariaLabel, offsetRight, onClick }, children);
  };
  return import_react2.default.createElement(internal_default3, Object.assign({}, baseProps, props, { variant: "navigation", customTriggerBuilder: dropdownTrigger, preferCenter: true }));
};
  ...
  if (definition.type === "button") {
    ...
    if (definition.variant === "primary-button") {
      return import_react3.default.createElement(
        ...
        import_react3.default.createElement(InternalButton, { variant: "primary", href: definition.href, target: definition.external ? "_blank" : void 0, onClick: definition.onClick, onFollow: definition.onFollow, ariaLabel, iconName: definition.iconName, iconUrl: definition.iconUrl, iconAlt: definition.iconAlt, iconSvg: definition.iconSvg }, shouldHideText ? null : import_react3.default.createElement(
          import_react3.default.Fragment,
          null,
          definition.text,
          definition.external && import_react3.default.createElement(
            import_react3.default.Fragment,
            null,
            " ",
            import_react3.default.createElement(
              ...
              import_react3.default.createElement(internal_default, { name: "external" })
            )
          )
        ))
      );
      ...
      return import_react3.default.createElement(
        ...
        import_react3.default.createElement(
          ...
          hasIcon && import_react3.default.createElement(internal_default, { name: definition.iconName, url: definition.iconUrl, alt: definition.iconAlt, svg: definition.iconSvg, badge: definition.badge }),
          !shouldHideText && definition.text && import_react3.default.createElement("span", { className: hasIcon ? styles_css_default2["utility-link-icon"] : void 0 }, definition.text)
        )
      );
    }
    ...
    return import_react3.default.createElement(menu_dropdown_default, Object.assign({}, definition, { title: shouldShowTitle ? title : "", ariaLabel, offsetRight }), !shouldHideText && definition.text);
  }
  return null;
}
...
var ViewContext = (0, import_react4.createContext)(defaultCtx);
var useNavigate = () => {
  const { setState } = (0, import_react4.useContext)(ViewContext);
...
var Route = ({ view, element }) => {
  const { state } = (0, import_react4.useContext)(ViewContext);
  if (view === state.view) {
    if (typeof element === "function") {
      return element(state.data);
    }
    return import_react4.default.createElement(import_react4.default.Fragment, null, element);
  }
  return null;
};
var Router = ({ children }) => {
  const [state, setState] = (0, import_react4.useState)({ view: "utilities", data: null });
  return import_react4.default.createElement(ViewContext.Provider, { value: { state, setState } }, children);
};
...
var Header = ({ children, secondaryText, backIconAriaLabel, dismissIconAriaLabel, onBack, onClose }) => {
  return import_react5.default.createElement(
    ...
    onBack && import_react5.default.createElement(
      internal_default2,
      {
    ...
    import_react5.default.createElement(
      ...
      import_react5.default.createElement("div", { className: styles_css_default2["overflow-menu-header-text--title"] }, children),
      secondaryText && import_react5.default.createElement("div", { className: styles_css_default2["overflow-menu-header-text--secondary"] }, secondaryText)
    ),
    import_react5.default.createElement(
      internal_default2,
      {
...
var ListItem = ({ children, startIcon, endIcon }) => {
  return import_react6.default.createElement(
    ...
    null,
    startIcon && import_react6.default.createElement("span", { className: styles_css_default2["overflow-menu-list-item-icon"] }, startIcon),
    import_react6.default.createElement("span", { className: styles_css_default2["overflow-menu-list-item-text"] }, children),
    endIcon && endIcon
  );
};
var LinkItem = (0, import_react6.forwardRef)(({ children, external, href, target, rel, startIcon, endIcon, onClick, context, testId }, ref) => {
  ...
  return import_react6.default.createElement(
    ...
    import_react6.default.createElement(ListItem, { startIcon, endIcon }, children)
  );
});
var ButtonItem = (0, import_react6.forwardRef)(({ children, startIcon, endIcon, onClick, testId }, ref) => {
  return import_react6.default.createElement(
    "button",
...
var NavigationItem = (0, import_react6.forwardRef)((_a, ref) => {
  var { startIcon, children, index, testId } = _a, definition = __rest(_a, ["startIcon", "children", "index", "testId"]);
  const navigate = useNavigate();
  return import_react6.default.createElement(ButtonItem, { ref, startIcon, endIcon: import_react6.default.createElement(internal_default, { name: "angle-right" }), testId, onClick: () => navigate("dropdown-menu", {
    definition,
...
var ExpandableItem = (_a) => {
  ...
  return import_react6.default.createElement(
    ...
    import_react6.default.createElement(
      ...
      import_react6.default.createElement(
        ListItem,
        { endIcon: import_react6.default.createElement(
          "span",
          { className: clsx_m_default(styles_css_default2.icon, expanded && styles_css_default2.expanded) },
          import_react6.default.createElement(internal_default, { name: "caret-up-filled" })
        ) },
        import_react6.default.createElement("span", { id: headerId }, children)
      )
    ),
    expanded && import_react6.default.createElement("ul", { className: clsx_m_default(styles_css_default2["overflow-menu-list"], styles_css_default2["overflow-menu-list-submenu"]), "aria-labelledby": headerId }, definition.items.map((item, index) => {
      const isGroup = typeof item.items !== "undefined";
      return import_react6.default.createElement("li", { key: index, className: clsx_m_default(styles_css_default2[`overflow-menu-list-item`], styles_css_default2[`overflow-menu-list-item-dropdown-menu`]) }, dropdownComponentFactory(item, isGroup, onItemClick));
    }))
  );
};
function utilityComponentFactory(utility, index, ref) {
  ...
  const startIcon = hasIcon && import_react6.default.createElement(internal_default, { name: utility.iconName, url: utility.iconUrl, alt: utility.iconAlt, svg: utility.iconSvg });
  switch (utility.type) {
    case "button": {
      ...
      const content = import_react6.default.createElement(
        import_react6.default.Fragment,
        null,
        label,
        utility.external && import_react6.default.createElement(
          import_react6.default.Fragment,
          null,
          " ",
          import_react6.default.createElement(
            ...
            import_react6.default.createElement(internal_default, { name: "external", size: "normal" })
          )
        )
      );
      if (!utility.href) {
        return import_react6.default.createElement(ButtonItem, { ref, startIcon, onClick: handleClick, testId: `__${index}` }, content);
      }
      return import_react6.default.createElement(LinkItem, { ref, startIcon, href: utility.href, external: utility.external, target: utility.target, rel: utility.rel, testId: `__${index}`, onClick: handleClick }, content);
    }
    case "menu-dropdown": {
      return import_react6.default.createElement(NavigationItem, Object.assign({ ref, startIcon, index }, utility, { testId: `__${index}` }), label);
    }
  }
}
function dropdownComponentFactory(item, expandable, onItemClick) {
  ...
  const startIcon = hasIcon && import_react6.default.createElement(internal_default, { name: item.iconName, url: item.iconUrl, alt: item.iconAlt, svg: item.iconSvg });
  if (expandable) {
    return import_react6.default.createElement(ExpandableItem, Object.assign({}, item, { onItemClick }), label);
  }
  return import_react6.default.createElement(
    LinkItem,
    ...
    label,
    item.external && import_react6.default.createElement(
      import_react6.default.Fragment,
      null,
      " ",
      import_react6.default.createElement(
...
var UtilityMenuItem = (0, import_react6.forwardRef)((_a, ref) => {
  var { index } = _a, props = __rest(_a, ["index"]);
  return import_react6.default.createElement("li", { className: clsx_m_default(styles_css_default2[`overflow-menu-list-item`], styles_css_default2[`overflow-menu-list-item-utility`]) }, utilityComponentFactory(props, index, ref));
});
var SubmenuItem = (props) => {
  const expandable = typeof props.items !== "undefined";
  return import_react6.default.createElement("li", { className: clsx_m_default(styles_css_default2[`overflow-menu-list-item`], styles_css_default2[`overflow-menu-list-item-submenu`], expandable && styles_css_default2[`overflow-menu-list-item-expandable`]) }, dropdownComponentFactory(props, expandable, props.onClick));
};
...
var UtilitiesView = ({ headerText, dismissIconAriaLabel, onClose, items = [], focusIndex }) => {
  ...
  return import_react7.default.createElement(
    ...
    import_react7.default.createElement(
      ...
      import_react7.default.createElement("span", { id: headerId }, headerText)
    ),
    import_react7.default.createElement("ul", { className: styles_css_default2["overflow-menu-list"], "aria-labelledby": headerId }, items.map((utility, index) => import_react7.default.createElement(UtilityMenuItem, Object.assign({ key: index, index, ref: index === focusIndex ? ref : void 0, onClose }, utility))))
  );
};
...
var SubmenuView = ({ onClose, utilityIndex, headerText, headerSecondaryText, dismissIconAriaLabel, backIconAriaLabel, definition }) => {
  ...
  return import_react8.default.createElement(
    ...
    import_react8.default.createElement("ul", { className: clsx_m_default(styles_css_default2["overflow-menu-list"], styles_css_default2["overflow-menu-list-submenu"]), "aria-labelledby": headerId }, definition.items.map((item, index) => import_react8.default.createElement(SubmenuItem, Object.assign({ key: index }, item, { onClick: (event, item2) => {
...
var OverflowMenu = ({ headerText, dismissIconAriaLabel, backIconAriaLabel, items = [], onClose }) => {
  ...
  return import_react9.default.createElement(
    ...
    import_react9.default.createElement(
      router_default,
      null,
      import_react9.default.createElement(Route, { view: "utilities", element: (data) => import_react9.default.createElement(utilities_default, { headerText: i18n("i18nStrings.overflowMenuTitleText", headerText), items, focusIndex: data === null || data === void 0 ? void 0 : data.utilityIndex, dismissIconAriaLabel: renderedDismissIconAriaLabel, backIconAriaLabel: renderedBackIconAriaLabel, onClose }) }),
      import_react9.default.createElement(Route, { view: "dropdown-menu", element: (data) => import_react9.default.createElement(submenu_default, { headerText: data === null || data === void 0 ? void 0 : data.headerText, headerSecondaryText: data === null || data === void 0 ? void 0 : data.headerSecondaryText, dismissIconAriaLabel: renderedDismissIconAriaLabel, backIconAriaLabel: renderedBackIconAriaLabel, definition: data === null || data === void 0 ? void 0 : data.definition, utilityIndex: data === null || data === void 0 ? void 0 : data.utilityIndex, onClose }) })
    )
  );
};
...
function InternalTopNavigation(_a) {
      ...
      import_react10.default.createElement(
        ...
        showIdentity && import_react10.default.createElement(
          ...
          import_react10.default.createElement(
            ...
            identity.logo && import_react10.default.createElement("img", { role: "img", src: (_a2 = identity.logo) === null || _a2 === void 0 ? void 0 : _a2.src, alt: (_b = identity.logo) === null || _b === void 0 ? void 0 : _b.alt, className: clsx_m_default(styles_css_default2.logo, {
              [styles_css_default2.narrow]: isNarrowViewport
            }) }),
            showTitle && import_react10.default.createElement("span", { className: styles_css_default2.title }, identity.title)
          )
        ),
        showSearchSlot && import_react10.default.createElement(
          "div",
          { className: styles_css_default2.inputs },
          import_react10.default.createElement("div", { className: clsx_m_default(styles_css_default2.search, !isVirtual && isSearchExpanded && styles_css_default2["search-expanded"]) }, search)
        ),
        import_react10.default.createElement(
          "div",
  ...
  return import_react10.default.createElement(
    ...
    import_react10.default.createElement(
      ...
      content(false),
      import_react10.default.createElement(Portal, null, content(true)),
...
function TopNavigation(_a) {
  ...
  return import_react11.default.createElement(InternalTopNavigation, Object.assign({}, baseComponentProps, { utilities }, restProps));
}
...
//# sourceMappingURL=chunk-D52YJJRF.js.map
