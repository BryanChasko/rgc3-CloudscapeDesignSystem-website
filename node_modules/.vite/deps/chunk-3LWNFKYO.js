...
import {
  InternalModal
} from "./chunk-JH4U53LA.js";
import {
  checkControlled
} from "./chunk-NIE4X67Y.js";
import {
  InternalFormField
...
import "/home/bryanchasko/code/rgc3/node_modules/@cloudscape-design/components/collection-preferences/styles.scoped.css";
...
var ModalContentLayout = ({ left, right }) => {
  ...
  if (smallContainer) {
    return import_react.default.createElement(
      "div",
      { ref },
      left && import_react.default.createElement("div", null, left),
      right && import_react.default.createElement("div", { className: clsx_m_default(left && styles_css_default["second-column-small"]) }, right)
    );
  }
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement(
      ...
      left && import_react.default.createElement("div", null, left),
      right && import_react.default.createElement("div", null, right)
    )
  );
};
var PageSizePreference = ({ title, options, value, onChange }) => {
  ...
  return import_react.default.createElement(
    "div",
    { className: styles_css_default["page-size"] },
    import_react.default.createElement(
      InternalFormField,
      { label: i18n("pageSizePreference.title", title), stretch: true, className: styles_css_default["page-size-form-field"] },
      import_react.default.createElement(internal_default3, { className: styles_css_default["page-size-radio-group"], value: `${value}`, items: options.map(({ label, value: value2 }) => ({ label, value: `${value2}` })), onChange: ({ detail }) => onChange(parseInt(detail.value, 10)) })
    )
  );
};
var WrapLinesPreference = ({ label, description, value, onChange }) => {
  const i18n = useInternalI18n("collection-preferences");
  return import_react.default.createElement(internal_default2, { checked: !!value, description: i18n("wrapLinesPreference.description", description), onChange: ({ detail }) => onChange(detail.checked), className: styles_css_default["wrap-lines"] }, i18n("wrapLinesPreference.label", label));
};
function StripedRowsPreference({ label, description, value, onChange }) {
  const i18n = useInternalI18n("collection-preferences");
  return import_react.default.createElement(internal_default2, { checked: !!value, description: i18n("stripedRowsPreference.description", description), onChange: ({ detail }) => onChange(detail.checked), className: styles_css_default["striped-rows"] }, i18n("stripedRowsPreference.label", label));
}
var ContentDensityPreference = ({ label, description, value, onChange }) => {
  const i18n = useInternalI18n("collection-preferences");
  return import_react.default.createElement(internal_default2, { checked: value === "compact", description: i18n("contentDensityPreference.description", description), onChange: ({ detail }) => onChange(detail.checked ? "compact" : "comfortable"), className: styles_css_default["content-density"] }, i18n("contentDensityPreference.label", label));
};
var StickyPreference = ({ firstOrLast, preference, value, onChange }) => {
  const { title, description, options } = preference;
  return import_react.default.createElement(
    "div",
    { className: styles_css_default[`sticky-columns-${firstOrLast}`] },
    import_react.default.createElement(
      InternalFormField,
      { className: styles_css_default["sticky-columns-form-field"], label: title, description },
      import_react.default.createElement(internal_default3, { className: styles_css_default["sticky-columns-radio-group"], value: typeof value !== "undefined" ? `${value}` : null, items: options.map(({ label, value: value2 }) => ({ label, value: `${value2}` })), onChange: ({ detail }) => onChange(Number(detail.value)) })
    )
  );
};
var StickyColumnsPreference = ({ firstColumns, lastColumns, onChange, value }) => {
  return import_react.default.createElement(
    InternalSpaceBetween,
    { className: styles_css_default["sticky-columns"], size: "l" },
    firstColumns && import_react.default.createElement(StickyPreference, { firstOrLast: "first", preference: firstColumns, value: value === null || value === void 0 ? void 0 : value.first, onChange: (newValue) => onChange(Object.assign(Object.assign({}, value), { first: newValue })) }),
    lastColumns && import_react.default.createElement(StickyPreference, { firstOrLast: "last", preference: lastColumns, value: value === null || value === void 0 ? void 0 : value.last, onChange: (newValue) => onChange(Object.assign(Object.assign({}, value), { last: newValue })) })
  );
};
var CustomPreference = ({ value, customPreference, onChange }) => {
  const [customState, setCustomState] = (0, import_react.useState)(value);
  if (customPreference) {
    return import_react.default.createElement("div", { className: styles_css_default.custom }, customPreference(customState, (value2) => {
...
import "/home/bryanchasko/code/rgc3/node_modules/@cloudscape-design/components/toggle/styles.scoped.css";
...
// node_modules/@cloudscape-design/components/toggle/internal.js
var InternalToggle = import_react2.default.forwardRef((_a, ref) => {
  ...
  const checkboxRef = (0, import_react2.useRef)(null);
  useForwardFocus(ref, checkboxRef);
  return import_react2.default.createElement(AbstractSwitch, Object.assign({}, baseProps, { className: clsx_m_default(styles_css_default2.root, baseProps.className), controlClassName: clsx_m_default(styles_css_default2["toggle-control"], {
    [styles_css_default2["toggle-control-checked"]]: checked,
    [styles_css_default2["toggle-control-disabled"]]: disabled
  }), outlineClassName: styles_css_default2.outline, controlId, disabled, label: children, description, descriptionBottomPadding: true, ariaLabel, ariaLabelledby, ariaDescribedby, ariaControls, nativeControl: (nativeControlProps) => import_react2.default.createElement("input", Object.assign({}, nativeControlProps, {
    ref: checkboxRef,
    type: "checkbox",
    checked,
    name,
    ...
    import_react2.default.createElement("span", { className: clsx_m_default(styles_css_default2["toggle-handle"], {
      [styles_css_default2["toggle-handle-checked"]]: checked,
      [styles_css_default2["toggle-handle-disabled"]]: disabled
    }) })
  ), __internalRootRef }));
});
var internal_default4 = InternalToggle;

// node_modules/@cloudscape-design/components/collection-preferences/visible-content.js
var isVisible = (id, visibleIds) => visibleIds.indexOf(id) !== -1;
var className = (suffix) => ({
  className: styles_css_default[`visible-content-${suffix}`]
});
function VisibleContentPreference({ title, options, value = [], onChange }) {
  ...
  const selectionOption = (option, optionGroupIndex, optionIndex) => {
    ...
    return import_react3.default.createElement(
      ...
      import_react3.default.createElement("label", Object.assign({}, className("option-label"), { htmlFor: labelId }), option.label),
      import_react3.default.createElement(
        "div",
        Object.assign({}, className("toggle")),
        import_react3.default.createElement(internal_default4, { checked: isVisible(option.id, value), onChange: () => onToggle(option.id), disabled: option.editable === false, controlId: labelId })
      )
    );
  };
  ...
  return import_react3.default.createElement(
    "div",
    { className: styles_css_default["visible-content"] },
    import_react3.default.createElement("h3", Object.assign({}, className("title"), { id: outerGroupLabelId }), title),
    import_react3.default.createElement(InternalSpaceBetween, Object.assign({}, className("groups"), { size: "xs" }), options.map((optionGroup, optionGroupIndex) => {
      ...
      return import_react3.default.createElement(
        ...
        import_react3.default.createElement("div", Object.assign({}, className("group-label"), { id: groupLabelId }), optionGroup.label),
        import_react3.default.createElement("div", null, optionGroup.options.map((option, optionIndex) => selectionOption(option, optionGroupIndex, optionIndex)))
      );
    }))
  );
}
...
function useInterval() {
  ...
  const set = (0, import_react4.useCallback)((listener, duration) => {
...
function useLazyMemo(callback, dependencies) {
  const valueRef = (0, import_react4.useRef)();
  return (0, import_react4.useMemo)(
    () => {
...
function useNodeRef(onChange) {
  ...
  const node = (0, import_react4.useRef)(null);
  const setNodeRef = (0, import_react4.useCallback)(
    (element) => {
...
function useAnnouncement() {
  const [announcement, setAnnouncement] = (0, import_react5.useState)("");
  const announce = (0, import_react5.useCallback)((value) => {
    if (value != null) {
...
// node_modules/@dnd-kit/core/dist/core.esm.js
var DndMonitorContext = (0, import_react6.createContext)(null);
function useDndMonitor(listener) {
  const registerListener = (0, import_react6.useContext)(DndMonitorContext);
...
function useDndMonitorProvider() {
  const [listeners] = (0, import_react6.useState)(() => /* @__PURE__ */ new Set());
  const registerListener = (0, import_react6.useCallback)((listener) => {
    listeners.add(listener);
    return () => listeners.delete(listener);
  }, [listeners]);
  const dispatch = (0, import_react6.useCallback)((_ref) => {
    let {
      type,
      event
    } = _ref;
...
function Accessibility(_ref) {
  ...
  useDndMonitor((0, import_react6.useMemo)(() => ({
    onDragStart(_ref2) {
      let {
        active
      } = _ref2;
  ...
  const markup = import_react6.default.createElement(import_react6.default.Fragment, null, import_react6.default.createElement(HiddenText, {
    id: hiddenTextDescribedById,
    value: screenReaderInstructions.draggable
  }), import_react6.default.createElement(LiveRegion, {
    id: liveRegionId,
    announcement
  }));
...
function useAutoScroller(_ref) {
  ...
  const scrollSpeed = (0, import_react6.useRef)({
    x: 0,
    y: 0
  });
  const scrollDirection = (0, import_react6.useRef)({
    x: 0,
    y: 0
  });
  const rect = (0, import_react6.useMemo)(() => {
    switch (activator) {
  ...
  const autoScroll = (0, import_react6.useCallback)(() => {
  ...
  const sortedScrollableAncestors = (0, import_react6.useMemo)(() => order === TraversalOrder.TreeOrder ? [...scrollableAncestors].reverse() : scrollableAncestors, [order, scrollableAncestors]);
  (0, import_react6.useEffect)(
    () => {
...
function useCombineActivators(sensors, getSyntheticHandler) {
  return (0, import_react6.useMemo)(() => sensors.reduce((accumulator, sensor) => {
    const {
      sensor: Sensor
    } = sensor;
...
function useDroppableMeasuring(containers, _ref) {
  ...
  const [queue, setQueue] = (0, import_react6.useState)(null);
  const {
    frequency,
    measure,
    strategy
  } = config;
  const containersRef = (0, import_react6.useRef)(containers);
  const disabled = isDisabled();
  const disabledRef = useLatestValue(disabled);
  const measureDroppableContainers = (0, import_react6.useCallback)(function(ids2) {
    if (ids2 === void 0) {
      ids2 = [];
    }
...
function useMutationObserver(_ref) {
  ...
  const mutationObserver = (0, import_react6.useMemo)(() => {
...
function useRect(element, measure, fallbackRect) {
  ...
  const [rect, measureRect] = (0, import_react6.useReducer)(reducer2, null);
...
function useScrollableAncestors(node) {
  const previousNode = (0, import_react6.useRef)(node);
...
function useScrollOffsets(elements) {
  const [scrollCoordinates, setScrollCoordinates] = (0, import_react6.useState)(null);
  const prevElements = (0, import_react6.useRef)(elements);
  const handleScroll = (0, import_react6.useCallback)((event) => {
...
function useScrollOffsetsDelta(scrollOffsets, dependencies) {
  ...
  const initialScrollOffsets = (0, import_react6.useRef)(null);
  (0, import_react6.useEffect)(
    () => {
...
function useWindowRect(element) {
  return (0, import_react6.useMemo)(() => element ? getWindowClientRect(element) : null, [element]);
}
var defaultValue$2 = [];
function useRects(elements, measure) {
  ...
  const [rects, measureRects] = (0, import_react6.useReducer)(reducer2, defaultValue$2);
  const resizeObserver = useResizeObserver({
...
function useDragOverlayMeasuring(_ref) {
  ...
  const handleResize = (0, import_react6.useCallback)((entries) => {
    for (const {
      target
    } of entries) {
  ...
  const handleNodeChange = (0, import_react6.useCallback)((element) => {
...
var InternalContext = (0, import_react6.createContext)(defaultInternalContext);
var PublicContext = (0, import_react6.createContext)(defaultPublicContext);
...
function RestoreFocus(_ref) {
  ...
  const {
    ...
    activatorEvent,
    draggableNodes
  } = (0, import_react6.useContext)(InternalContext);
...
var ActiveDraggableContext = (0, import_react6.createContext)({
  ...defaultCoordinates,
  scaleX: 1,
  scaleY: 1
});
...
var DndContext = (0, import_react6.memo)(function DndContext2(_ref) {
  ...
  const store = (0, import_react6.useReducer)(reducer, void 0, getInitialState);
  const [state, dispatch] = store;
  const [dispatchMonitorEvent, registerMonitorListener] = useDndMonitorProvider();
  const [status, setStatus] = (0, import_react6.useState)(Status.Uninitialized);
  ...
  const activeRects = (0, import_react6.useRef)({
    initial: null,
    translated: null
  });
  ...
  const [activeSensor, setActiveSensor] = (0, import_react6.useState)(null);
  const [activatorEvent, setActivatorEvent] = (0, import_react6.useState)(null);
  const latestProps = useLatestValue(props, Object.values(props));
  const draggableDescribedById = useUniqueId2("DndDescribedBy", id);
  const enabledDroppableContainers = (0, import_react6.useMemo)(() => droppableContainers.getEnabled(), [droppableContainers]);
  ...
  const activationCoordinates = (0, import_react6.useMemo)(() => activatorEvent ? getEventCoordinates(activatorEvent) : null, [activatorEvent]);
  ...
  const sensorContext = (0, import_react6.useRef)({
    activatorEvent: null,
    active: null,
    activeNode,
    collisionRect: null,
  ...
  const instantiateSensor = (0, import_react6.useCallback)(
    (event, _ref2) => {
      let {
        sensor: Sensor,
        options
  ...
  const bindActivatorToSensorInstantiator = (0, import_react6.useCallback)((handler, sensor) => {
  ...
  const publicContext = (0, import_react6.useMemo)(() => {
    const context = {
      active,
      activeNode,
      activeNodeRect,
  ...
  const internalContext = (0, import_react6.useMemo)(() => {
    const context = {
      activatorEvent,
      activators,
      active,
  ...
  return import_react6.default.createElement(DndMonitorContext.Provider, {
    value: registerMonitorListener
  }, import_react6.default.createElement(InternalContext.Provider, {
    value: internalContext
  }, import_react6.default.createElement(PublicContext.Provider, {
    value: publicContext
  }, import_react6.default.createElement(ActiveDraggableContext.Provider, {
    value: transform
  }, children)), import_react6.default.createElement(RestoreFocus, {
    disabled: (accessibility == null ? void 0 : accessibility.restoreFocus) === false
  })), import_react6.default.createElement(Accessibility, {
    ...accessibility,
...
var NullContext = (0, import_react6.createContext)(null);
...
function useDraggable(_ref) {
  ...
  const transform = (0, import_react6.useContext)(isDragging ? ActiveDraggableContext : NullContext);
  ...
  const memoizedAttributes = (0, import_react6.useMemo)(() => ({
    role,
    tabIndex,
...
function useDndContext() {
  return (0, import_react6.useContext)(PublicContext);
}
...
function useDroppable(_ref) {
  ...
  const previous = (0, import_react6.useRef)({
    disabled
  });
  const resizeObserverConnected = (0, import_react6.useRef)(false);
  const rect = (0, import_react6.useRef)(null);
  const callbackId = (0, import_react6.useRef)(null);
  const {
  ...
  const handleNodeChange = (0, import_react6.useCallback)((newElement, previousElement) => {
    if (!resizeObserver) {
      return;
    }
    if (previousElement) {
...
function AnimationManager(_ref) {
  ...
  const [clonedChildren, setClonedChildren] = (0, import_react6.useState)(null);
  const [element, setElement] = (0, import_react6.useState)(null);
  ...
  return import_react6.default.createElement(import_react6.default.Fragment, null, children, clonedChildren ? (0, import_react6.cloneElement)(clonedChildren, {
    ref: setElement
  }) : null);
}
...
function NullifiedContextProvider(_ref) {
  ...
  return import_react6.default.createElement(InternalContext.Provider, {
...
var PositionedOverlay = (0, import_react6.forwardRef)((_ref, ref) => {
  let {
    as,
    activatorEvent,
  ...
  return import_react6.default.createElement(as, {
    className: className2,
    style: styles,
    ref
  }, children);
...
var DragOverlay = import_react6.default.memo((_ref) => {
  let {
  ...
  const transform = (0, import_react6.useContext)(ActiveDraggableContext);
  ...
  return import_react6.default.createElement(NullifiedContextProvider, null, import_react6.default.createElement(AnimationManager, {
    animation: dropAnimation
  }, active && key2 ? import_react6.default.createElement(PositionedOverlay, {
    key: key2,
    id: active.id,
    ref,
    as: wrapperElement,
...
var Context = import_react7.default.createContext({
  activeIndex: -1,
...
function SortableContext(_ref) {
  ...
  const items = (0, import_react7.useMemo)(() => userDefinedItems.map((item) => typeof item === "object" && "id" in item ? item.id : item), [userDefinedItems]);
  const isDragging = active != null;
  const activeIndex = active ? items.indexOf(active.id) : -1;
  const overIndex = over ? items.indexOf(over.id) : -1;
  const previousItemsRef = (0, import_react7.useRef)(items);
...
function useDerivedTransform(_ref) {
  ...
  const [derivedTransform, setDerivedtransform] = (0, import_react7.useState)(null);
  const previousIndex = (0, import_react7.useRef)(index);
  useIsomorphicLayoutEffect(() => {
...
function useSortable(_ref) {
  ...
  } = (0, import_react7.useContext)(Context);
  ...
  const itemsAfterCurrentSortable = (0, import_react7.useMemo)(() => items.slice(items.indexOf(id)), [items, id]);
  const {
    rect,
    node,
    isOver,
  ...
  const previous = (0, import_react7.useRef)({
    activeId,
    items,
    newIndex,
    containerId
...
import "/home/bryanchasko/code/rgc3/node_modules/@cloudscape-design/components/internal/components/handle/styles.scoped.css";
...
function Handle(props) {
  return import_react8.default.createElement("div", Object.assign({ role: "button", tabIndex: 0 }, props, { onPointerDown: props.onPointerDown, className: clsx_m_default(styles_css_default3.handle, props.className) }));
}

// node_modules/@cloudscape-design/components/internal/components/drag-handle/styles.css.js
import "/home/bryanchasko/code/rgc3/node_modules/@cloudscape-design/components/internal/components/drag-handle/styles.scoped.css";
...
function DragHandle({ attributes, hideFocus, listeners }) {
  return import_react9.default.createElement(
    Handle,
    Object.assign({ className: clsx_m_default(styles_css_default4.handle, hideFocus && styles_css_default3["hide-focus"]) }, attributes, listeners),
    import_react9.default.createElement(internal_default, { name: "drag-indicator" })
  );
}
...
var getClassName = (suffix) => styles_css_default[[componentPrefix, suffix].filter(Boolean).join("-")];
var ContentDisplayOption = (0, import_react10.forwardRef)(({ dragHandleAriaLabel, listeners, onToggle, option }, ref) => {
  ...
  return import_react10.default.createElement(
    ...
    import_react10.default.createElement(DragHandle, { attributes: dragHandleAttributes, listeners }),
    import_react10.default.createElement("label", { className: getClassName("label"), htmlFor: controlId }, option.label),
    import_react10.default.createElement(
      "div",
      { className: getClassName("toggle") },
      import_react10.default.createElement(internal_default4, { checked: !!option.visible, onChange: () => onToggle && onToggle(option), disabled: option.alwaysVisible === true, controlId })
    )
  );
});
...
function DraggableOption({ dragHandleAriaLabel, onKeyDown, onToggle, option }) {
  ...
  return import_react11.default.createElement(
    "li",
    { className: clsx_m_default(getClassName(), isDragging && styles_css_default.placeholder, isSorting && styles_css_default.sorting), style },
    import_react11.default.createElement(content_display_option_default, { ref: setNodeRef, listeners: combinedListeners, dragHandleAriaLabel, onToggle, option })
  );
}
...
function useDragAndDropReorder({ sortedOptions }) {
  const isKeyboard = (0, import_react12.useRef)(false);
  const positionDelta = (0, import_react12.useRef)(0);
  const [activeItemId, setActiveItemId] = (0, import_react12.useState)(null);
...
function useLiveAnnouncements({ isDragging, liveAnnouncementDndStarted, liveAnnouncementDndItemReordered, liveAnnouncementDndItemCommitted, liveAnnouncementDndDiscarded, sortedOptions }) {
  const isFirstAnnouncement = (0, import_react13.useRef)(true);
  if (!isDragging) {
...
var getClassName2 = (suffix) => styles_css_default[`${componentPrefix2}-${suffix}`];
function ContentDisplayPreference({ title, description, options, value = options.map(({ id }) => ({
  ...
  return import_react14.default.createElement(
    "div",
    { className: styles_css_default[componentPrefix2] },
    import_react14.default.createElement("h3", { className: getClassName2("title"), id: titleId }, i18n("contentDisplayPreference.title", title)),
    import_react14.default.createElement("p", { className: getClassName2("description"), id: descriptionId }, i18n("contentDisplayPreference.description", description)),
    import_react14.default.createElement(
      ...
      import_react14.default.createElement(
        ...
        import_react14.default.createElement(SortableContext, { items: sortedOptions.map(({ id }) => id), strategy: verticalListSortingStrategy }, sortedOptions.map((option) => {
          return import_react14.default.createElement(DraggableOption, { dragHandleAriaLabel: i18n("contentDisplayPreference.dragHandleAriaLabel", dragHandleAriaLabel), key: option.id, onKeyDown: handleKeyDown, onToggle, option });
        }))
      ),
      import_react14.default.createElement(
        Portal,
        null,
        import_react14.default.createElement(DragOverlay, { className: styles_css_default["drag-overlay"], dropAnimation: null, style: { zIndex: 5e3 } }, activeOption && import_react14.default.createElement(content_display_option_default, { listeners: { onKeyDown: handleKeyDown }, dragHandleAriaLabel: i18n("contentDisplayPreference.dragHandleAriaLabel", dragHandleAriaLabel), onToggle, option: activeOption }))
      )
    )
  );
}
...
function CollectionPreferences(_a) {
  ...
  const i18n = useInternalI18n("collection-preferences");
  const baseProps = getBaseProps(rest);
  const [modalVisible, setModalVisible] = (0, import_react15.useState)(false);
  const [temporaryPreferences, setTemporaryPreferences] = (0, import_react15.useState)(copyPreferences(preferences || {}));
  const triggerRef = (0, import_react15.useRef)(null);
  const dialogPreviouslyOpen = (0, import_react15.useRef)(false);
  ...
  return import_react15.default.createElement(
    "div",
    Object.assign({}, baseProps, { className: clsx_m_default(baseProps.className, styles_css_default.root), ref: __internalRootRef }),
    import_react15.default.createElement(InternalButton, { ref: triggerRef, className: styles_css_default["trigger-button"], disabled, ariaLabel: i18n("title", title), onClick: () => {
      setTemporaryPreferences(copyPreferences(preferences || {}));
      setModalVisible(true);
    }, variant: "icon", iconName: "settings", formAction: "none" }),
    !disabled && modalVisible && import_react15.default.createElement(
      InternalModal,
      { className: styles_css_default["modal-root"], visible: true, header: i18n("title", title), footer: import_react15.default.createElement(
        InternalBox,
        { float: "right" },
        import_react15.default.createElement(
          InternalSpaceBetween,
          { direction: "horizontal", size: "xs" },
          import_react15.default.createElement(InternalButton, { className: styles_css_default["cancel-button"], variant: "link", formAction: "none", onClick: onCancelListener }, i18n("cancelLabel", cancelLabel)),
          import_react15.default.createElement(InternalButton, { className: styles_css_default["confirm-button"], variant: "primary", formAction: "none", onClick: onConfirmListener }, i18n("confirmLabel", confirmLabel))
        )
      ), closeAriaLabel: cancelLabel, size: hasContentOnTheLeft && hasContentOnTheRight ? "large" : "medium", onDismiss: onCancelListener },
      import_react15.default.createElement(ModalContentLayout, { left: hasContentOnTheLeft && import_react15.default.createElement(
        InternalSpaceBetween,
        { size: "l" },
        pageSizePreference && import_react15.default.createElement(PageSizePreference, Object.assign({ value: temporaryPreferences.pageSize }, pageSizePreference, { onChange: (pageSize) => onChange({ pageSize }) })),
        wrapLinesPreference && import_react15.default.createElement(WrapLinesPreference, Object.assign({ value: temporaryPreferences.wrapLines }, wrapLinesPreference, { onChange: (wrapLines) => onChange({ wrapLines }) })),
        stripedRowsPreference && import_react15.default.createElement(StripedRowsPreference, Object.assign({ value: temporaryPreferences.stripedRows }, stripedRowsPreference, { onChange: (stripedRows) => onChange({ stripedRows }) })),
        contentDensityPreference && import_react15.default.createElement(ContentDensityPreference, Object.assign({ value: temporaryPreferences.contentDensity }, contentDensityPreference, { onChange: (contentDensity) => onChange({ contentDensity }) })),
        stickyColumnsPreference && import_react15.default.createElement(StickyColumnsPreference, Object.assign({ value: temporaryPreferences.stickyColumns }, stickyColumnsPreference, { onChange: (stickyColumns) => onChange({ stickyColumns }) })),
        customPreference && import_react15.default.createElement(CustomPreference, { value: temporaryPreferences.custom, customPreference, onChange: (custom) => onChange({ custom }) })
      ), right: contentDisplayPreference ? import_react15.default.createElement(ContentDisplayPreference, Object.assign({}, contentDisplayPreference, { value: temporaryPreferences.contentDisplay, onChange: (contentDisplay) => onChange({ contentDisplay }) })) : visibleContentPreference && import_react15.default.createElement(VisibleContentPreference, Object.assign({ value: temporaryPreferences.visibleContent }, visibleContentPreference, { onChange: (visibleItems) => onChange({ visibleContent: visibleItems }) })) })
    )
  );
}
...
//# sourceMappingURL=chunk-3LWNFKYO.js.map
